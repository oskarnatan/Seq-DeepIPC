...
from log.aim_mt_seq1_pred5.config import GlobalConfig #pakai config.py yang dicopykan ke log
# import random
# random.seed(0)
# torch.manual_seed(0)
...
def test(data_loader, model, config):
    ...
    with torch.no_grad():
        ...
        for data in data_loader:
            ...
            total_metric = (1-metric_seg.item()) + metric_dep.item() + metric_wp.item()
